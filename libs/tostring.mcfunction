...
$execute if data storage $(argument) {type:"boolean",value:true} run data modify storage $(result) type set value "string"
$execute if data storage $(argument) {type:"boolean",value:true} run return run data modify storage $(result) value set value "true"
$execute if data storage $(argument) {type:"boolean",value:false} run data modify storage $(result) type set value "string"
...
$execute unless data storage $(argument) {type:"object"} run say TypeError: Conversion to string failed.
